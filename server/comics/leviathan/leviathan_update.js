...
var leviathan_update_data = function (manhwa, date) {
...
var leviathan_update = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dom, manhwa, manhwas, i, page, manhwa_not_updated, LAST_UPDATE_MANHWA_NAME, current_date, _loop_1, state_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                Types_1.DefaultManhwa.source = 'Leviathan';
                i = 0;
                page = 1;
            ...
            case 2:
                ...
                return [4 /*yield*/, axios.get("https://luminousscans.com/series/?page=".concat(page, "&order=update?2022-09-19"))
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, leviathan_update_data(manhwa, current_date)
