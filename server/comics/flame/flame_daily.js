...
var flame_get_daily = function (manhwa) { return __awaiter(void 0, void 0, void 0, function () {
    var data, release;
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (typeof (data.status) !== 'undefined' && data.status !== 'Coming Soon!') {
                    data.update = new Date("".concat(release.getElementsByClassName('chapterdate')[0].innerHTML, " UTC")).toISOString();
...
var flame_daily = function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                data = Types_1.DefaultManhwa;
                                return [4 /*yield*/, flame_get_daily(manhwa)
                                        .then(function (res_data) { data = res_data; })["catch"](function (err) { return console.log("error with getting data from flame_data_daily"); })];
                            case 1:
                                _b.sent();
