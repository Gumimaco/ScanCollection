        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cloudscraper.get(manhwa.getElementsByTagName('a')[0].attributes[0].value)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, cloudscraper.get("https://flamescans.org/series/?page=".concat(page, "&status=&type=&order=update"))
