...
var asura_update = function () { return __awaiter(void 0, void 0, void 0, function () {
    var dom, manhwa, manhwas, i, page, manhwa_not_updated, LAST_UPDATE_MANHWA_NAME, _loop_1, state_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, DB_functions_1.last_manhwa_updated)(Types_1.DefaultManhwa.Source)
                        .then(function (data) { return LAST_UPDATE_MANHWA_NAME = data; })["catch"](function (err) { return console.log("LASTTTTT"); })];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2:
                        ...
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, asura_data_update(manhwa)
                                        .then(function (update_data) { return data = update_data; })["catch"](function (err) { return console.log("ERROR IN RETRIEVING DATA FROM FUNCTION ASURA_GET_DATA"); })
